...
var config = (function (exports, legendMotionAnimationDriver, animationResolver, react) {
    'use strict';

    var config = {
        componentPath: '/components',
        theme: react.createConfig({
            aliases: {
                bg: 'backgroundColor',
            ...
            plugins: [new animationResolver.AnimationResolver(legendMotionAnimationDriver.MotionAnimationDriver)],
        }),
    };
    react.createComponents({
        MyBox: {
            theme: {
                'bg': '$pink500',
                ':initial': {
...
})({}, gluestackStyleLegendMotionAnimationDriver, gluestackStyleAnimationResolver, gluestackStyleReact);
